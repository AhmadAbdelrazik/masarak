...
type Memory struct {
	...
	applicationsHistory []*applicationshistory.ApplicationHistory
...
func NewMemory() *Memory {
	return &Memory{
		...
		applicationsHistory: make([]*applicationshistory.ApplicationHistory, 0),
	}
}
...
func NewInMemoryRepositories(mem *Memory) *app.Repositories {
	return &app.Repositories{
		...
		ApplicationHistory: NewInMemoryApplicationHistoryRepository(mem),
	}
}
